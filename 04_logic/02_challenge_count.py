...
def validate_balance(text:str):
    return text.lower().count("j") == text.lower().count("r")

print(validate_balance("RRJJ"))
print(validate_balance("RRRRJJ"))
print(validate_balance("RRJJJJJJ"))
print(validate_balance("awwwaqAQAQA"))